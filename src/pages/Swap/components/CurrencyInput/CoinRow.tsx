...
const CoinRow: React.FC<TProps> = ({ item }) => {
  ...
  return (
    <div className="flex w-full items-center justify-between gap-2 px-2 font-Rany text-white_gray_05 hover:bg-white_gray_bg dark:text-gray_05 dark:hover:bg-gray_008">
